sap.ui.define(["sap/ui/core/mvc/Controller","sap/ui/richtexteditor/library"], function (Controller) {
  "use strict";

  return Controller.extend("my.project1.controller.clientCreate", {
    onInit: function () {

...
public class TestSimple {
  ...
  public static void main(String[] args) {
    try {
      ...
      Developer john = createDeveloper("siva", "siva@gmail.com");
      entityManager.persist(john);
      
      Developer elumalai = createDeveloper("Elumalai", "elumalai@gmail.com");
      entityManager.persist(elumalai);

      Developer jane = createDeveloper("venkatesan", "jane@doe.com");

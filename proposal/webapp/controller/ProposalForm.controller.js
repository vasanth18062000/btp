...
onSubSection: function () {
      ...
      saveMainSection: function () {
        ...
        this._mainSections.forEach(function (mainSectionId) {
          ...
          if (mainSectionInput) {
            var mainSectionData = {
              smainSectionTitle: mainSectionInput.getValue(),
            ...
            title : mainSectionData.smainSectionTitle,
            
            };

            var apiUrl = "https://6cec300atrial-dev-sap-btp-rfpn-test1-srv.cfapps.us10-001.hana.ondemand.com/odata/v4/proposal-system-services/PS_MAIN_SECTION";
            ...
            $.ajax({
              ...
              error: function (error) {
                ...
                MessageToast.show("Error occured " + error);
              }
            });
      ...
      saveSubSection: function () {
        ...
        this._subSections.forEach(function (subSectionId) {
          ...
          if (subSectionInput) {
            ...
            // Perform the save operation, e.g., using OData service or AJAX call
            // ...
...
onStepChanged: function (oEvent) {
        ...
        if (this.onSubSection.inputId<currentStepIndex){

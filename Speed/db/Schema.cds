...
entity ContactDetails:  managed{
    ...
    warehouseContactId:Association to Warehouse
}
...
entity Product:  temporal, managed{
    ...
    sellerId:String(50);
    stock:Association to many StockLevel on stock.product=$self;
}
...
entity StockLevel:   managed{
    ...
    product    :   Association to Product;
    warehouseId:Association to many Warehouse on warehouseId.stocks=$self;
}
...
entity Warehouse:   managed{
    ...
    // contactPersonMobileNumber   :   String(50);
    // contactPersonEmailId        :   String(50);
    contactDetails:Association to many ContactDetails on contactDetails.warehouseContactId=$self;
    stocks:Association to StockLevel;
}
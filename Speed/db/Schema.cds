...
using { com.ladera.utcl.contact as contact} from '../db/ContactDetails';
...
firstName      :String(50);
lastName       :String(50);
contactDetails :Composition of contact.ContactDetails on contactDetails.customer=$self;
dateOfBirth    :Date;
...
price           :Double;
currency        :Currency;
unit            :String @assert.range enum {KG;METER;GRAM;LENGTH;INCH;LITRE;PCS;};
...
deliveryContact :Association to contact.ContactDetails;
paymentMode     :String @assert.range enum{
COD;PO;};
...
entity Warehouse: managed{
    ...
    contactDetails              :Association to many contact.ContactDetails;

					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 DEPLOY APP",
									"targetURL": "#ui5deploy-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ui5deploy-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5deploy",
									"url": sap.ui.require.toUrl("ui5deploy")
								}
							}
						}
					}

sap.ui.require([
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "com.car.carmanagement.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of com.car.carmanagement"
                        },
                        success: function() {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title com.car.carmanagement"
                    });
                }
            }

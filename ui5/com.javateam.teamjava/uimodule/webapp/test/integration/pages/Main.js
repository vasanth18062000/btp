sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/actions/Press"], function (Opa5, Press) {
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "com.javateam.teamjava.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of com.javateam.teamjava",
                        },
                        success: function () {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title com.javateam.teamjava",
                    });
                },
            },
        },

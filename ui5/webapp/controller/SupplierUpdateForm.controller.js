sap.ui.define([
    ...
    return Controller.extend("ns.ui5.controller.SupplierUpdateForm", {
        onInit: function () {
        ...
        onObjectMatched(oEvent) {
          ...
          associated:function(){
            ...
            oModel.read("/ProposalSupplier("+selectedItem+")",{
                ...
                //    debugger;  
                    data=response;
                    data = Object.assign({}, { mId: data.id,name:data.name,website:data.website });

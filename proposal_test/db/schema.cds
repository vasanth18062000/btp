...
entity PS_VENDOR_ORG_CONTACT: managed{
     key id                                :   Integer;
...
entity PS_CUSTOMER_ORG:managed{
     key id                                 :   Integer;
    name                                   :   String(100);
    logo                                   :   LargeBinary;
    website                                 :   String;
...
entity PS_CUSTOMER_ORG_CONTACT:managed{
    key id                                 :   Integer;
    addressLine1                           :   String(30);
    addressLine2                           :   String(50);
    addressLine3                           :   String(50);
...
entity PS_MAIN_SECTION:managed{
     key id                                 :   Integer;
    title                                  :   String;
...
entity PS_PROJECT_TYPE:managed{
     key id                                 :   Integer;
    projectType                            :   String;

}

entity PS_TEMPLATE:managed{
    Key id                                 :   Integer;
    name                                   :   String;
    description                            :   String;
    // createdBy                              :   String(50);

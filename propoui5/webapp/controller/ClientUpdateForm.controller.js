sap.ui.define([
    ...
    return Controller.extend("ns.propoui5.controller.ClientUpdateForm", {
        onInit: function () {
        ...
        onUpdate : function(){
            ...
            var sID=this.getView().byId("id").getValue()
               ...
               oModel.update("/ProposalCustomer(" + sID + ")", oEntry, {
                ...
                //   jQuery.ajax({
                //       url: sServiceUrl + "ProposalCustomer(" + encodeURIComponent(sID) + ")",
                //       method: "PATCH",
                //       contentType: "application/json",
                //       data: JSON.stringify(oEntry),      
                //     success: function () {
                //         // MessageToast.show("Added Successfully");
                //         var idss=this.getView().byId("ID").getValue();
                        var oEntrydetails = {
                          id: parseInt(this.getView().byId("ID").getValue()),
                        ...
                        oModel.update("/ProposalCustomerContact(" + sID + ")", oEntrydetails, {
                            method: "PUT",
                    success: function () {
                        onBusyDialog.close();

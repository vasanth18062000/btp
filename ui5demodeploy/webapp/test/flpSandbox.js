		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Demo",
									"targetURL": "#nsui5demodeploy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsui5demodeploy-display": {
								"semanticObject": "nsui5demodeploy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.ui5demodeploy",
									"url": sap.ui.require.toUrl("ns/ui5demodeploy")
								}
							}
						}
					}

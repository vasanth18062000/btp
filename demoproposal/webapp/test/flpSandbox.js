		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DEMO PROPOSAL",
									"targetURL": "#nsdemoproposal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdemoproposal-display": {
								"semanticObject": "nsdemoproposal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.demoproposal",
									"url": sap.ui.require.toUrl("ns/demoproposal")
								}
							}
						}
					}

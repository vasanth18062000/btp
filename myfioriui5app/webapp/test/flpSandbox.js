		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Demo",
									"targetURL": "#nsmyfioriui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsmyfioriui5app-display": {
								"semanticObject": "nsmyfioriui5app",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.myfioriui5app",
									"url": sap.ui.require.toUrl("ns/myfioriui5app")
								}
							}
						}
					}
